...
async def setup(bot):
    ...
    async def register_notice(interaction: discord.Interaction, scrapper: str):
        ...
        try:
            ...
            if interaction.client.scrapper_config.add_scrapper(channel_id, scrapper_type):
                await interaction.response.send_message(
    ...
    async def unregister_notice(interaction: discord.Interaction, type: str):
        ...
        try:
            ...
            if interaction.client.scrapper_config.remove_scrapper(channel_id, scrapper_type):
